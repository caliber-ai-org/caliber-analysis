...
export function mapLine(line, fallbackSessionId) {
...
export function mapLines(rawLines, fallbackSessionId) {
  return rawLines.map((line) => mapLine(line, fallbackSessionId));
}
